window.addEventListener("DOMContentLoaded", () => {
  ...
  function generateGPAForm(numCourses) {
    ...
    for (i = 1; i <= numCourses; i++) {
      ...
      div.innerHTML = `
        <h4 style="color:white;">Course ${i}</h4>
        ...
        <input id="grade${i}" type="text" name="letterGrades" class="letterGrades" pattern="[A-D,F]{1}" maxlength="1" placeholder="Enter single capital letter" required>`;
      form.append(div);
    }
